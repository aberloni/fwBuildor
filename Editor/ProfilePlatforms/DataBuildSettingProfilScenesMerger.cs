...
namespace fwp.buildor
{
    ...
    public class DataBuildSettingProfilScenesMerger : ScriptableObject
    {
        ...
        {
            DataBuildSettingProfilScenesMerger merger = BuildorHelper.getScriptableObjectInEditor<DataBuildSettingProfilScenesMerger>("everything");
        ...
        public static void injectAll(string filter = "everything")
        {
            ...
            DataBuildSettingProfilScenesMerger merger = BuildorHelper.getScriptableObjectInEditor<DataBuildSettingProfilScenesMerger>(filter);
